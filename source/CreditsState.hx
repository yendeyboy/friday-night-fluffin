...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color //weird ass black glitch need fixing
		...
		[''],
		['Honarable Mentions'],
		['Magma Blood',		'transparent',		'1st Muscian of \nFriday Night Fluffin',					'https://www.youtube.com/channel/UCAn8fpAtoU1iRPrJDiswhog',	0xFFFFFFFF],
		['HoldenHanna',		'transparent',		'Author of Catnip and Catastrophe',					'https://www.fiverr.com/holdenhanna',	0xFFafd6db],
		['Mendes',		'transparent',		'Help with Color Pallets',					'',	0xFFFFFFFF],
		['Discord Lmao',		'discord',		'press enter \nnow',					'https://www.youtube.com/watch?v=dQw4w9WgXcQ',	0xFF5865F2],
		[''],
        ['Psych Engine Team'],
